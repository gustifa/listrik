        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{(!empty($profileData->photo)) ? url('upload/guru_images/'.$profileData->photo): url('upload/no_image.jpg')}}" class="user-img" alt="user avatar">
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('guru.password')}}"><i class="bx bx-cog fs-5"></i><span>Ganti Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('guru.logout')}}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
